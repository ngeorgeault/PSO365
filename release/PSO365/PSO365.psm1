...
function Add-SharePointModernSite {
    <#
    .EXTERNALHELP PSO365-help.xml
    .LINK
        https://github.com/rdtechie/PSO365/tree/master/release/0.0.1/docs/Functions/Add-SharePointModernSite.md
    #>
    ...
    begin {
        ...
        if (-not(Get-PnPTenantSite -Url ( -join ($TenantUrl, '/sites/', $Alias)) -ErrorAction SilentlyContinue)) {
            ...
            Write-Warning -Message "Site $Alias already exists, exiting..."
        }
    }
    process {
    }
