# Run this in an administrative PowerShell prompt to install the PSO365 PowerShell module:
#
# 	iex (New-Object Net.WebClient).DownloadString("https://github.com/rdtechie/PSO365/raw/master/Install.ps1")

# Some general variables
$ModuleName = 'PSO365'
$DownloadURL = 'https://github.com/rdtechie/PSO365/raw/master/release/PSO365-current.zip'
